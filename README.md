...
| --- | --- | --- |
| `NEXT_PUBLIC_SITE_URL` | Recommended on production | Canonical URL, no trailing slash (e.g. `https://www.lkautocare.net`). Used for OG tags, canonical, sitemap, JSON-LD. |
...
8. Environment Variables → add for **Production**:
   - `NEXT_PUBLIC_SITE_URL` = `https://www.lkautocare.net`
...
2. Add `lkautocare.net` and `www.lkautocare.net` (prefer **www** as primary)
3. Set DNS as Vercel instructs
4. Update `NEXT_PUBLIC_SITE_URL` to `https://www.lkautocare.net` and redeploy
